...
func TestGetRootForClone(t *testing.T) {
	bugMappings := map[int]string{
		1843407: `{"bugs" : [{ "alias" : [], "assigned_to" : "Si", "assigned_to_detail" : {"email" : "","id" : 420,"name" : "","real_name" : "Si" }, "blocks" : [1844101 ], "cc" : [], "cc_detail" : [ ], "cf_clone_of" : null, "cf_doc_type" : "If docs needed, set a value", "cf_environment" : "", "cf_fixed_in" : "", "cf_last_closed" : null, "cf_release_notes" : "", "cf_target_upstream_version" : "", "classification" : "Red Hat", "component" : ["Unknown" ], "creation_time" : "2020-06-03T09:03:41Z", "creator" : "Gal Zaidman", "creator_detail" : {"email" : "gz","id" : 422274,"name" : "gzaidman","real_name" : "Gal Zaidman" }, "deadline" : null, "depends_on" : [], "docs_contact" : "", "dupe_of" : null, "groups" : [], "id" : 1843407, "is_cc_accessible" : true, "is_confirmed" : true, "is_creator_accessible" : true, "is_open" : true, "keywords" : [], "last_change_time" : "2020-06-07T11:08:27Z", "op_sys" : "Unspecified", "platform" : "Unspecified", "priority" : "unspecified", "product" : "OpenShift Container Platform", "qa_contact" : "Jianwei Hou", "qa_contact_detail" : {"email" : "j","id" : 332453,"name" : "jhou","real_name" : "Jianwei Hou" }, "resolution" : "", "see_also" : [], "severity" : "medium", "status" : "VERIFIED", "summary" : "[oVirt] add oVirt as a provide to openshift tests", "target_milestone" : "---", "target_release" : ["4.6.0" ], "url" : "", "version" : ["4.5" ], "whiteboard" : ""}],"faults" : []}`,
		1844101: `{"bugs" : [{ "alias" : [], "assigned_to" : "Gal Zaidman", "assigned_to_detail" : {"email" : "gn","id" : 4224,"name" : "gzn","real_name" : "Gman" }, "blocks" : [1844102 ], "cc" : [ ], "cc_detail" : [], "cf_clone_of" : null, "cf_doc_type" : "If docs needed, set a value", "cf_environment" : "", "cf_fixed_in" : "", "cf_last_closed" : null, "cf_release_notes" : "", "cf_target_upstream_version" : "", "classification" : "Red Hat", "component" : ["Unknown" ], "creation_time" : "2020-06-04T15:43:10Z", "creator" : "OpenShift BugZilla Robot", "creator_detail" : {"email" : "","id" : 1,"name" : "openshift-bugzilla-robot","real_name" : "OpenShift BugZilla Robot" }, "deadline" : null, "depends_on" : [1843407 ], "docs_contact" : "", "dupe_of" : null, "groups" : [], "id" : 1844101, "is_cc_accessible" : true, "is_confirmed" : true, "is_creator_accessible" : true, "is_open" : true, "keywords" : ["CodeChange" ], "last_change_time" : "2020-06-11T05:39:35Z", "op_sys" : "Unspecified", "platform" : "Unspecified", "priority" : "unspecified", "product" : "OpenShift Container Platform", "qa_contact" : "Gal Zaidman", "qa_contact_detail" : {"email" : "","id" : 422274,"name" : "gzaidman","real_name" : "Gal Zaidman" }, "resolution" : "", "see_also" : [], "severity" : "medium", "status" : "VERIFIED", "summary" : "[oVirt] add oVirt as a provide to openshift tests", "target_milestone" : "---", "target_release" : ["4.5.0" ], "url" : "", "version" : ["4.5" ], "whiteboard" : ""}],"faults" : []}`,
		1844102: `{"bugs" : [ {"alias" : [],"assigned_to" : "Gal Zaidman","assigned_to_detail" : {"email" : "gz","id" : 44,"name" : "gzman","real_name" : "Gman"},"blocks" : [],"cc" : [],"cc_detail" : [],"cf_clone_of" : null,"cf_doc_type" : "If docs needed, set a value","cf_environment" : "","cf_fixed_in" : "","cf_last_closed" : null,"cf_release_notes" : "","cf_target_upstream_version" : "","classification" : "Red Hat","component" : ["Cloud Compute"],"creation_time" : "2020-06-04T15:43:52Z","creator" : "OpenShift BugZilla Robot","creator_detail" : {"email" : "","id" : 1,"name" : "openshift-bugzilla-robot","real_name" : "OpenShift BugZilla Robot"},"deadline" : null,"depends_on" : [1844101],"docs_contact" : "","dupe_of" : null,"groups" : [],"id" : 1844102,"is_cc_accessible" : true,"is_confirmed" : true,"is_creator_accessible" : true,"is_open" : true,"keywords" : [],"last_change_time" : "2020-06-11T05:39:58Z","op_sys" : "Unspecified","platform" : "Unspecified","priority" : "unspecified","product" : "OpenShift Container Platform","qa_contact" : "Lucie Leistnerova","qa_contact_detail" : {"email" : "lle","id" : 399127,"name" : "l","real_name" : "Lucie Leistnerova"},"resolution" : "","see_also" : [],"severity" : "medium","status" : "POST","summary" : "[oVirt] add oVirt as a provide to openshift tests","target_milestone" : "---","target_release" : ["4.4.z"],"url" : "","version" : ["4.5"],"whiteboard" : "" }],"faults" : []}`,
	}
	testServer := httptest.NewTLSServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		if r.Header.Get("X-BUGZILLA-API-KEY") != "api-key" {
			t.Error("did not get api-key passed in X-BUGZILLA-API-KEY header")
